...
#define FLASH_END_ADDRESS (flashLayout[FLASH_LAST_SEGMENT_IDX].sector_start + flashLayout[FLASH_LAST_SEGMENT_IDX].sector_size - 1)
...
blt_bool FlashWriteChecksum(void) {
   ...
   */
    ...
    /* write the checksum */
    return FlashWrite(flashLayout[0].sector_start + BOOT_FLASH_VECTOR_TABLE_CS_OFFSET, sizeof(blt_addr), (blt_int8u *)&signature_checksum);
