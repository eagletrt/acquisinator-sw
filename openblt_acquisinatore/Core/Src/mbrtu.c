...
void MbRtuInit(void) {
   ...
   */
    ASSERT_CT((BOOT_COM_MBRTU_CHANNEL_INDEX == 0) || (BOOT_COM_MBRTU_CHANNEL_INDEX == 1) || (BOOT_COM_MBRTU_CHANNEL_INDEX == 2));
   ...
   */
     ...
     */
        mbRtuT3_5Ticks = (blt_int16u)(((3850000UL + (BOOT_COM_MBRTU_BAUDRATE - 1U)) / BOOT_COM_MBRTU_BAUDRATE) + 1);
    }
...
blt_bool MbRtuReceivePacket(blt_int8u *data, blt_int8u *len) {
     ...
     */
       ...
       */
           ...
           */
                    if ((rxPacket[0] == BOOT_COM_MBRTU_NODE_ID) && (rxPacket[1] == BOOT_COM_MBRTU_FCT_CODE_USER_XCP)) {
