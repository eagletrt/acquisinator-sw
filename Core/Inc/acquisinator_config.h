...
#define FROM_mV_TO_ROD_ELONGATION(mVval)                                                                                             \
    ((STRAIN_GAUGE_RNOM -                                                                                                            \
      ((STRAIN_GAUGE_R2 * STRAIN_GAUGE_R3) -                                                                                         \
       (STRAIN_GAUGE_R2 * ((mVval - STRAIN_GAUGE_VREF) / STRAIN_GAUGE_G) * (STRAIN_GAUGE_R1 + STRAIN_GAUGE_R2)) / STRAIN_GAUGE_VS) / \
          (STRAIN_GAUGE_R1 +                                                                                                         \
           ((((mVval - STRAIN_GAUGE_VREF) / STRAIN_GAUGE_G) * (STRAIN_GAUGE_R1 + STRAIN_GAUGE_R2)) / STRAIN_GAUGE_VS))) /            \
